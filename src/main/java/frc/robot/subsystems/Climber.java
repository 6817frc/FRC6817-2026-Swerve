...
public class Climber extends SubsystemBase {
  ...
  public Climber() {
     ...
     * climbLeadConfig.closedLoop.feedbackSensor(FeedbackSensor.kAbsoluteEncoder).
     * pid(0.3, 0, 0);
     ...
     * 
     * m_climbLead.configure(climbLeadConfig, ResetMode.kNoResetSafeParameters,
     * PersistMode.kNoPersistParameters);
     * m_climbFollow.configure(climbFollowConfig, ResetMode.kNoResetSafeParameters,
     * PersistMode.kNoPersistParameters);
     */
  }
